...
const (
	Dkron_GetJob_FullMethodName               = "/types.Dkron/GetJob"
	Dkron_ExecutionDone_FullMethodName        = "/types.Dkron/ExecutionDone"
	Dkron_Leave_FullMethodName                = "/types.Dkron/Leave"
	Dkron_SetJob_FullMethodName               = "/types.Dkron/SetJob"
	Dkron_DeleteJob_FullMethodName            = "/types.Dkron/DeleteJob"
	Dkron_RunJob_FullMethodName               = "/types.Dkron/RunJob"
	Dkron_DeleteExecutions_FullMethodName     = "/types.Dkron/DeleteExecutions"
	Dkron_ToggleJob_FullMethodName            = "/types.Dkron/ToggleJob"
	Dkron_RaftGetConfiguration_FullMethodName = "/types.Dkron/RaftGetConfiguration"
	Dkron_RaftRemovePeerByID_FullMethodName   = "/types.Dkron/RaftRemovePeerByID"
	Dkron_GetActiveExecutions_FullMethodName  = "/types.Dkron/GetActiveExecutions"
	Dkron_SetExecution_FullMethodName         = "/types.Dkron/SetExecution"
)
