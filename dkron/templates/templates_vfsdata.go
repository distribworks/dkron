...
var Templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 4, 12, 16, 40, 11, 670246603, time.UTC),
		},
		"/busy.html.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "busy.html.tmpl",
			modTime:          time.Date(2020, 4, 12, 16, 40, 11, 669378877, time.UTC),
		...
		"/dashboard.html.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 5, 7, 12, 57, 54, 647996209, time.UTC),
		...
		"/executions.html.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 4, 12, 16, 40, 11, 670701137, time.UTC),
