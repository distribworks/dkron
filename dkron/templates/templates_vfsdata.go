...
var Templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 8, 2, 12, 15, 15, 71217023, time.UTC),
		},
		"/dashboard.html.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "dashboard.html.tmpl",
			modTime:          time.Date(2019, 8, 2, 9, 9, 13, 339163089, time.UTC),
		...
		"/status.html.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 2, 12, 15, 15, 71684782, time.UTC),
