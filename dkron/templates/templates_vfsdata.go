...
var Templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 8, 20, 12, 47, 36, 534494635, time.UTC),
		},
		"/dashboard.html.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "dashboard.html.tmpl",
			modTime:          time.Date(2019, 8, 12, 22, 41, 56, 476783326, time.UTC),
		...
		"/executions.html.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 12, 22, 41, 56, 477691098, time.UTC),
		...
		"/jobs.html.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "jobs.html.tmpl",
			modTime:          time.Date(2019, 8, 20, 12, 47, 36, 534654308, time.UTC),
		...
		"/status.html.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 12, 22, 41, 56, 479240834, time.UTC),
